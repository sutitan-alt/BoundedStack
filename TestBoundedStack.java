...
System.out.println("testBoundedStack");
    ...
    bottles.push(1);   
        ...
        check("capacity ต้องมากกว่า 0 และไม่เกิน MAX_BOTTLES", true); // ค่าความจุจะต้องมากกว่า 0 และไม่เกินค่าสูงสุดของขวดน้ำ
       ...
       BoundedStack testnull = new BoundedStack(1);
        ...
        check("ตู้กดน้ำสามารถเติมขวดน้ำได้",true);
        try {
        ...
        check("ขวดน้ำในตัวโคลนมีค่าเหมือนกัน",copyBoundedStack.peek().equals(2)); // ตรวจสอบขวดน้ำว่าเป็นแบบเดียวกันหรือไม่
        copyBoundedStack.pop(); //ลองนำขวดน้ำออกเพื่อดูขวดอื่น
        check("ขวดน้ำอื่น ๆ ในตัวโคลนมีค่าเหมือนกันแม้มีการนำขวดน้ำขวดอื่นออกจากตู้",copyBoundedStack.peek().equals(1)); // ขวดน้ำจะต้องเป็นค่าเดิม
